...
namespace GEngine
{
	namespace Utils
	{
		GLenum RenderImage2DFormatToGLInternalFormat(RenderImage2DFormat format)
		{
			switch (format)
			{
			case RENDER_IMAGE_2D_FORMAT_RGBA8_UNORM:	return GL_RGBA8;
			case RENDER_IMAGE_2D_FORMAT_RGBA8_SNORM:	return GL_RGBA8_SNORM;
			case RENDER_IMAGE_2D_FORMAT_RGB8_UNORM:		return GL_RGB8;
			case RENDER_IMAGE_2D_FORMAT_RGB8_SNORM:		return GL_RGB8_SNORM;
			default:
				break;
			}
			return GL_RGBA8;
		...
		GLenum RenderImage2DFormatToGLDataFormat(RenderImage2DFormat format)
		{
			switch (format)
			{
			case RENDER_IMAGE_2D_FORMAT_RGBA8_UNORM:	return GL_RGBA;
			case RENDER_IMAGE_2D_FORMAT_RGBA8_SNORM:	return GL_RGBA_SNORM;
			case RENDER_IMAGE_2D_FORMAT_RGB8_UNORM:		return GL_RGB;
			case RENDER_IMAGE_2D_FORMAT_RGB8_SNORM:		return GL_RGB_SNORM;
			default:
				break;
			}
		}
		GLenum ComputeImage2DFormatToGLInternalFormat(ComputeImage2DFormat format)
		{
			switch (format)
			{
			case COMPUTE_IMAGE_2D_FORMAT_RGBA32_SFLOAT:		return GL_RGBA32F;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA16_SFLOAT:		return GL_RGBA16F;
			case COMPUTE_IMAGE_2D_FORMAT_RG32_SFLOAT:		return GL_RG32F;
			case COMPUTE_IMAGE_2D_FORMAT_RG16_SFLOAT:		return GL_RG16F;
			case COMPUTE_IMAGE_2D_FORMAT_R32_SFLOAT:		return GL_R32F;
			case COMPUTE_IMAGE_2D_FORMAT_R16_SFLOAT:		return GL_R16F;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA32_SINT:		return GL_RGBA32I;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA16_SINT:		return GL_RGBA16I;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA8_SINT:		return GL_RGBA8I;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA32_UINT:		return GL_RGBA32UI;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA16_UINT:		return GL_RGBA16UI;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA8_UINT:		return GL_RGBA8UI;
			case COMPUTE_IMAGE_2D_FORMAT_R32_UINT:			return GL_R32UI;
			default:
				break;
			}
			return GLenum();
		...
		GLenum ComputeImage2DFormatToGLDataFormat(ComputeImage2DFormat format)
		{
			switch (format)
			{
			case COMPUTE_IMAGE_2D_FORMAT_RGBA32_SFLOAT:		return GL_RGBA;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA16_SFLOAT:		return GL_RGBA;
			case COMPUTE_IMAGE_2D_FORMAT_RG32_SFLOAT:		return GL_RG;
			case COMPUTE_IMAGE_2D_FORMAT_RG16_SFLOAT:		return GL_RG;
			case COMPUTE_IMAGE_2D_FORMAT_R32_SFLOAT:		return GL_R;
			case COMPUTE_IMAGE_2D_FORMAT_R16_SFLOAT:		return GL_R;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA32_SINT:		return GL_RGBA;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA16_SINT:		return GL_RGBA;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA8_SINT:		return GL_RGBA;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA32_UINT:		return GL_RGBA;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA16_UINT:		return GL_RGBA;
			case COMPUTE_IMAGE_2D_FORMAT_RGBA8_UINT:		return GL_RGBA;
			case COMPUTE_IMAGE_2D_FORMAT_R32_UINT:			return GL_R;
				break;
			default:
				break;
			}
