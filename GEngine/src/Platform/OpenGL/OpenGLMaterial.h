...
namespace GEngine
{
	...
	public:
		...
		virtual bool IsOpaque() override { return m_BlendSourceFactor == GL_ONE && m_BlendDestinationFactor == GL_ZERO; }
	...
	private:
		...
		uint32_t											m_BlendSourceFactor		= GL_ONE;
		uint32_t											m_BlendDestinationFactor= GL_ZERO;
