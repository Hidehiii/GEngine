...
namespace GEngine
{
	...
	VulkanUniformBuffer::VulkanUniformBuffer(uint32_t size, uint32_t count, bool autoSetDataDynamic)
	{
	...
	void VulkanUniformBuffer::SetDataDynamic(const void* data, uint32_t size)
	{
