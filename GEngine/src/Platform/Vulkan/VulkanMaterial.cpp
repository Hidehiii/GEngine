...
namespace GEngine
{
	...
	VulkanMaterial::~VulkanMaterial()
	{
		...
		{
			const VkDescriptorPool descriptorPool = context->GetDescriptorPool();
			context->RetireResource([descriptorSets = std::move(descriptorSets), descriptorPool](VkDevice device) mutable
				{
