...
namespace GEngine
{
	...
	{
		if (KeyCodeToGLFWValue.find(keycode) != KeyCodeToGLFWValue.end())
	...
	{
		if (GLFWValueToKeyCode.find(glfwKeycode) != GLFWValueToKeyCode.end())
	...
	{
		if (MouseCodeToGLFWValue.find(mouseCode) != MouseCodeToGLFWValue.end())
	...
	{
		if (GLFWValueToMouseCode.find(glfwMouseCode) != GLFWValueToMouseCode.end())
